...
public class StreamConfig {
    ...
    public static class AVOptionsHolder {
        ...
        public static final int DEFAULT_PREVIEW_WIDTH = 347;

        public static final int DEFAULT_PREVIEW_HEIGHT = 289;

        public static final int DEFAULT_VIDEO_WIDTH = 347;

        public static final int DEFAULT_VIDEO_HEIGHT = 289;
